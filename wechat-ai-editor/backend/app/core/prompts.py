...
8. 图片位置用 [IMG:描述] 标记，如 [IMG:产品主图] [IMG:功能演示图]
9. 在文章末尾生成3-5个SEO关键词
...
6. 禁止使用"最好""第一""顶级"等绝对化用词
7. 禁止提及竞品名称（如美的、沁园、安吉尔等）
8. 图片位置用 [IMG:描述] 标记，如 [IMG:安装现场] [IMG:设备实拍]
9. 在文章末尾生成3-5个SEO关键词
...
6. 禁止使用"最好""第一""顶级"等绝对化用词
7. 禁止提及竞品名称（如美的、沁园、安吉尔等）
8. 图片位置用 [IMG:描述] 标记，如 [IMG:获奖证书] [IMG:颁奖现场]
9. 在文章末尾生成3-5个SEO关键词
...
6. 禁止使用"最好""第一""顶级"等绝对化用词
7. 禁止提及竞品名称（如美的、沁园、安吉尔等）
8. 图片位置用 [IMG:描述] 标记，如 [IMG:客户公司环境] [IMG:设备安装效果]
9. 在文章末尾生成3-5个SEO关键词
...
def get_system_prompt(content_type: str, tone: str) -> str:
    ...
    return template.format(company_info=PUDOW_COMPANY_INFO, tone=tone)
